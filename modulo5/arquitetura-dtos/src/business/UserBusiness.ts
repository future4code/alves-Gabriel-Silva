...
import { LoginInputDTO, SignupInputDTO, OutputLoginSignupDTO, User, USER_ROLES, GetUserInputDTO, GetUserInputDBDTO, GetUsersOutputDTO, InputDeleteUserDTO } from "../models/User"
...
export class UserBusiness {
    public signup = async (input: SignupInputDTO) => {
        ...
        const response: OutputLoginSignupDTO ={
    ...
    public getUsers = async (input: GetUserInputDTO) => {
        ...
        const users = usersDB.map(userDB => {
            ...
            const userResponse: GetUsersOutputDTO = {
                id: user.getId(),
                name: user.getName(),
                email: user.getEmail()
            }
    ...
    public deleteUser = async (input: InputDeleteUserDTO) => {
